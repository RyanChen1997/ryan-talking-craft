// @ts-nocheck
// Source: video-talkcraft / template/cards/type-contrast-emphasis.tsx
...
export default function TypeContrastEmphasis() {
...
export const Template = TypeContrastEmphasis;
