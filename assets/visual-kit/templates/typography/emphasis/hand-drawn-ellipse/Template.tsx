// @ts-nocheck
// Source: video-talkcraft / template/cards/hand-drawn-ellipse.tsx
...
export default function HandDrawnEllipse() {
  ...
  return (
    <AbsoluteFill style={{
      ...
      <svg id="inkLayer" viewBox="0 0 960 540" style={{ transform: "translateX(155px)" }}>
...
export const Template = HandDrawnEllipse;
