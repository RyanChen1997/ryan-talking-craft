// @ts-nocheck
// Source: video-talkcraft / template/cards/converging-arrows.tsx
...
export default function ConvergingArrows() {
  ...
  return (
    <AbsoluteFill style={{
      ...
      <svg id="arrowLayer" viewBox="0 0 960 540" style={{ transform: "translateX(152px)" }}>
        {arrows.map((paths, i) => {
...
export const Template = ConvergingArrows;
