// @ts-nocheck
// Source: video-talkcraft / template/cards/ink-underline.tsx
...
export default function InkUnderline() {
  ...
  return (
    <AbsoluteFill style={{
      ...
      <svg id="inkLayer" viewBox="0 0 960 540" style={{ transform: "translateX(-200px)" }}>
...
export const Template = InkUnderline;
