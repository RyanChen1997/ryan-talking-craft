// @ts-nocheck
// Source: video-talkcraft / template/cards/step-timeline-vertical.tsx
...
export default function StepTimelineVertical() {
...
export const Template = StepTimelineVertical;
